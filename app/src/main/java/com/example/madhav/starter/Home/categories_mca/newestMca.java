 ...
 */
public class newestMca extends Fragment {
    ...
    private RecyclerView recyclerView_new_mca;
    private RecyclerView.Adapter adapter_new_mca;
    private List<newestItemMca> newestMcaItems;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v =  inflater.inflate(R.layout.fragment_newest_mca, container, false);

        recyclerView_new_mca = (RecyclerView) v.findViewById(R.id.recyclerView_newest_mca);
        recyclerView_new_mca.setHasFixedSize(true);
        recyclerView_new_mca.setLayoutManager(new LinearLayoutManager(getActivity()));
        //app_count = v.findViewById(R.id.app_count);

        newestMcaItems = new ArrayList<>();
        loadRecyclerViewData_newest_mca();

        return v;
    }

    private void loadRecyclerViewData_newest_mca()
    {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            for(int i=0;i<array.length();i++){
                                ...
                                newestItemMca ui = new newestItemMca(
                                ...
                                newestMcaItems.add(ui);
                            }
                            adapter_new_mca = new adapter_newest_mca(newestMcaItems,getActivity());
                            //app_count.setText("Approved Projects : "+array.length());
                            recyclerView_new_mca.setAdapter(adapter_new_mca);
